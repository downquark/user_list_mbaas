...
users.post('/', function(req, res, next) {
    log.info(new Date(), 'In users route POST / req.body=', req.body);
    db({
        act: 'create',
        type: collection,
        fields: req.body
...
users.put('/:guid', function(req, res, next) {
    log.info(new Date(), 'In users route PUT / req.body=', req.body);
    db({
        act: 'update',
        type: collection,
...
users.get('/', function(req, res, next) {
    log.info(new Date(), 'In users route GET / query=', req.query);
    var options = {
        act: 'list',
        type: collection
    };
...
users.get('/:guid', function(req, res, next) {
    log.info(new Date(), 'In users route GET / guid=', req.params.guid);
    db({
        act:'read',
        type: collection,
        guid: req.params.guid
...
users.delete('/:guid', function(req, res, next) {
    log.info(new Date(), 'In users route DELETE / req.body=', req.body);
    db({
        act: 'delete',
        type: collection,
        guid: req.params.guid
